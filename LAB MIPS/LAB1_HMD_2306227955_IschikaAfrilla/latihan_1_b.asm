...
# calculate luas persegi panjang
	mult $t2, $t3
	mflo $t5
	add $t4, $t4, $t5
	j loop
...
exit:
	...
	li $v0, 4 # load immediate code 4 ke register $v0 untuk print string
	la $a0, output # load address dari label myString4 ke register $a0
	syscall
...
bisaDibagi:
	li $v0, 4 # load immediate code 4 ke register $v0 untuk print string
	la $a0, bisa # load address dari label myString4 ke register $a0
	syscall
	j exit2
	
tidakBisaDibagi:
	li $v0, 4 # load immediate code 4 ke register $v0 untuk print string
	la $a0, tidakBisa # load address dari label myString4 ke register $a0
	syscall
	j exit2
