...
; DEFINITIONS
;====================================================================
.include "m8515def.inc" ; type processor
.def temp = r16 ; temporary register
.def EW = r23 ; for PORTA
.def PB = r24 ; for PORTB
.def A  = r25 ; temporary register
.def count = r21 ; counter register
...
WRITE_HADIR: ; For printing "HADIR"
	lpm ; Load byte from program memory into r0
...
LOOP_LCD: ; Finish printing "HADIR"
	ret
...
WRITE_TANGGAL: ; For printing tanggal
	lpm ; Load byte from program memory into r0

	tst r0 ; Check if we've reached the end of the message2
...
LOOP_LCD_2: ; Finish printing tanggal
	ret
